...
const loginLink = document.querySelector(".form-box .bottom-link a");
const signupLink = document.querySelector(".form-box .bottom-link a");
...
hidePopupBtn.addEventListener("click", () => showPopupBtn.click() );
 ...
 loginLink.addEventListener("click", () => {
    fromPopup.classList.toggle(link.id ,"show-signup");
 });
